    ...
    <div className="flex items-center justify-center flex-col">
      ...
      >
        ...
        <h1 className="text-3xl md:text-6xl text-center mb-6 text-neutral-800">
          Todoshka helps team move
        </h1>
        <p className="text-3xl md:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white p-2 rounded-md w-fit">
          work forward.
        </p>
      </div>
      ...
      >
        ...
        it all with Todoshka.
      </p>

      <Button className="mt-6" size="lg" asChild>
        <Link href="/sign-up">Get Todoshka for free</Link>
      </Button>
    </div>
  );
};
